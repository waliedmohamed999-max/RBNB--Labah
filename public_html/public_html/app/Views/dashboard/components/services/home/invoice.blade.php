...
<ul class="nav nav-tabs nav-bordered">
    ...
    @endif
     <li class="nav-item">
            <a href="#tab-invoice-map" data-toggle="tab" id="map" aria-expanded="true" class="nav-link map">
                {{__('Address')}}
            </a>
        </li>
      @if($paymentObject::getName()== __('Bank Transfer'))
      <li class="nav-item">
        <a href="#tab-invoice-custome" data-toggle="tab" aria-expanded="true" class="nav-link">
            {{__('Receipt Image')}}
        </a>
    </li>
    @endif
...
<div class="tab-content">
    <div class="tab-pane active" id="tab-invoice-payment-info">
        <div class="payment-item">
            ...
            @endif
             <div class="item row align-items-center">
                <div class="col-4">
                    <h5 class="title">{{__('Labayh Commission')}}</h5>
                </div>
                <div class="col-8">
                    <span>{{ $bookingData['commission']['Commission'] }}%</span>
                </div>
            </div>
            <div class="item row align-items-center">
                <div class="col-4">
            ...
            <div class="item row align-items-center">
                ...
                <div class="col-8">
                    <span> {{ $bookingObject->total }}{{__('Rial')}}</span>
                </div>
            </div>
        </div>
    </div>
    <div class="tab-pane" id="tab-invoice-customer">
     ...
     <div class="tab-pane" id="tab-invoice-map">
        <div class="payment-item">
             <?php
            $modelName = 'App\\Models\\Home';
        $model = new $modelName();
        $home_id = $model->getById($bookingObject->service_id);
        
                $lat =  $home_id->location_lat;
                $lng =  $home_id->location_lng;
                $zoom = $home_id->location_zoom;
             ...
             <img data-src="{{asset('public/images/map.jpeg')}}" src="{{asset('public/images/map.jpeg')}}" width="350px">
                </a>
              </div>
                     
        </div>
    </div>
    <div class="tab-pane" id="tab-invoice-custome">
        <div class="payment-item text-center">
          
                  <a href="https://labayh.sa/images/{{$bookingObject->image}}" download>
                       <img src="https://labayh.sa/images/{{$bookingObject->image}}" width="350px">
                  </a> 
