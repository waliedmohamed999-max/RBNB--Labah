                ...
                <div class="row">
                    ...
                    <div class="d-none d-sm-block col-sm-6 col-md-6 col-xl-3">
                        <div class="card-box card-balance">
                            ...
                            <h4 class="mt-0 font-14">{{__('Balance')}}</h4>
                            <h2 class="my-3 text-center">
                                <span>{{  number_format(BlagatCommission(),2,",",".") }}ريال</span>
                            </h2>
                        </div>
                    </div>
                    ...
                    <div class="d-none d-sm-block col-sm-6 col-md-6 col-xl-3">
                        <div class="card-box card-net-earning">
                            ...
                            <h4 class="mt-0 font-14">{{__('Partner net profit')}}</h4>
                            <h2 class="my-3 text-center">
                                <span>{{  number_format(((((BlagatCommission('home')/1.05)*$Ctax)/100)+(((BlagatCommission('experience')/1.05)*$Etax)/100)),2,",",".") }}ريال</span>
                            </h2>
                        </div>
                    </div>
                    ...
                    <div class="d-none d-sm-block col-sm-6 col-md-6 col-xl-3">
                        <div class="card-box card-earning">
                            ...
                            <h4 class="mt-0 font-14">{{__('customer net profit')}}</h4>
                            <h2 class="my-3 text-center">
                                <span>{{number_format((((BlagatCommission()/1.05)*$Btax)/100),2,",",".")  }}ريال</span>
                            </h2>
                        </div>
                    </div>
                    ...
                    <div class="d-none d-sm-block col-sm-6 col-md-6 col-xl-3">
                        <div class="card-box card-payout">
                            ...
                            <h4 class="mt-0 font-14">{{__('Payout')}}</h4>
                            <h2 class="my-3 text-center">
                                <span>{{  PaymentsBlagat()==null?0: PaymentsBlagat() }}ريال</span>
                            </h2>
                        </div>
                    </div>
                </div>
