...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
                    ...
                    @if ($allUsers['total'])
                        @foreach ($allUsers['results'] as $item)
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <span class="role-status exp {{ $item->role_slug }}">{{ __($item->role_name) }}</span>
                                </td>
                                ...
                                $Agreement=checkAgreement($userID);
                                ...
                                <td class="align-middle text-center">
                                    <div class="dropdown dropleft">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a href="javascript:void(0)" class="dropdown-item" data-toggle="modal"
                                               data-params="{{ base64_encode(json_encode($params)) }}"
                                               data-target="#hh-payment-user-modal">{{__('Payout Information')}}</a>
                                               <!--@if ($Agreement != null)-->
                                               <!--<a href="javascript:void(0)" class="dropdown-item" data-toggle="modal"-->
                                               <!--data-params="{{ base64_encode(json_encode($params)) }}"-->
                                               <!--data-target="#hh-show-agreement-modal">{{__('agreement')}}</a>-->
                                               <!--@endif-->
            ...
            <div id="hh-show-agreement-modal" class="modal fade hh-get-modal-content" tabindex="-1" role="dialog"
            aria-hidden="true"
            data-url="{{ dashboard_url('get-agreement-item') }}"
            >
           <div class="modal-dialog">
               <div class="modal-content">
                   {{-- <form class="form form-action form-update-coupon-modal relative"
                         data-validation-id="form-update-user"
                         action="{{ dashboard_url('update-agreement-item') }}"> --}}
                       @include('common.loading')
                       <div class="modal-header">
                           <h4 class="modal-title">{{__('Update User')}}</h4>
                           <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×
...
<div id="hh-payment-user-modal" class="modal fade hh-get-modal-content" tabindex="-1" role="dialog"
            aria-hidden="true"
            data-url="{{ dashboard_url('get-payment-item') }}">
           <div class="modal-dialog">
               <div class="modal-content">
                   
                       @include('common.loading')
                       <div class="modal-header">
                           <h4 class="modal-title">{{__('Payout Information')}}</h4>
                           <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×
                           </button>
                       </div>
                       <div class="modal-body">
