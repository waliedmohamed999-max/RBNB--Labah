        ...
        <div class="content">
            ...
            <div class="card-box">
                <div class="header-area d-flex align-items-center">
                    ...
                    <h4 class="header-title mb-0">{{__('request partner')}}</h4>
               <a href="{{ dashboard_url('user-registration?rol=1')}}" class="btn btn-success" style="margin-right: 5%;">{{ __('request partner') }}</a>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                 ...
                                 <td class="align-middle">
                                    ...
                                    if($user->status == 0){
                                        echo '<span style="color:red">' . __('new request') . '</span>';
                                    }
                                    ?>
                                </td>
