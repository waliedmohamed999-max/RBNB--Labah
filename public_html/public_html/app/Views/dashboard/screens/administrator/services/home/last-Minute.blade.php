            ...
            <div class="card-box card-list-post">
                ...
                <table id="table-my-home" class="table table-large mb-0 dt-responsive nowrap w-100"
                    ...
                    <tr>
                       ...
                       <th data-priority="5" class="text-center"><span class="exp">{{__('Price last')}}</span></th> 
                        <th data-priority="6"><span class="exp">{{__('Home Type')}}</span></th>
                          <th data-priority="6"><span class="exp">{{__('timer')}}</span></th>
                        <th data-priority="-1" class="text-center">{{__('edit price')}}</th>
                         <th data-priority="-1" class="text-center">{{__('status')}}</th>
                    </tr>
                    </thead>
                    <tbody>
                    @if ($allHomes['total'])
                        @foreach ($allHomes['results'] as $item)
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                 ...
                                 <td class="align-middle">
                                     @if(isset($item->last) )
                                    <span class="exp ">{{ convert_price($item->price) }}</span>
                                    @endif
                                </td>
                                ...
                                <td class="align-middle">
                                   ...
                                   <td class="align-middle">
                                        @if(isset($item->last) )
                                          <div class="demo" style="color:red" data-startdate="{{ $item->creattted_at }}"></div>
                                           @endif
                                </td>
                               ...
                               data-action="{{ dashboard_url('change-last-status') }}"
                             data-params="{{ base64_encode(json_encode($data)) }}"
                               value="on" @if( $item->last == "1") checked @endif/>
                                           @endif
                                </td>
