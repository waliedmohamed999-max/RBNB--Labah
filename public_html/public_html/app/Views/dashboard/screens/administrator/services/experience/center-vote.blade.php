            ...
            <div class="card-box card-list-post">
                                ...
                                <td class="align-middle text-center">
                                    <div class="dropdown dropleft">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            $checkVote= checkEvent($experienceID);
                                            ?>
                                            <a class="dropdown-item" target="_blank"
                                            href="{{ dashboard_url('vote-ditails', $experienceID) }}">{{__('vote ditails')}}</a>
                                            <a class="dropdown-item" target="_blank"
                                            href="{{ dashboard_url('vote-entrant', $experienceID) }}">{{__('vote entrant')}}</a>
                                            @if($checkVote != null)
                                              <a class="dropdown-item hh-link-action hh-link-delete-experience text-danger    "
                                               data-action="{{ dashboard_url('vote-delete', $experienceID) }}"
                                               data-parent="tr"
                                               data-is-delete="true"
                                               data-confirm="yes"
                                               ...
                                               data-params="{{ base64_encode(json_encode($data)) }}"
                                               href="javascript: void(0)">{{__('vote delete')}}
                                            </a>
                                           @endif
                                            <a  type="button" class="dropdown-item addSub"  data-toggle="modal" data-target="#vote" data-experience_id="{{  $experienceID }}">
                                                {{__('add subs')}}</a>
                                        </div>
                                    </div>
                                </td>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <form action="{{ url('participants') }}" data-google-captcha="yes"
                    ...
                    <div class="modal-body">
                            <div class="form-group">
                            <label for="email-enquiry-form">{{ __('user phone') }} <span
                                    class="text-danger">*</span></label>
                            <input id="email-enquiry-form" type="number" name="userID"
