...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            ...
            {{--Start Content--}}
            <?php
            $current_user = App\Models\User::where('id',$Agreement->user_id)->first();
                        ...
                        <form action="{{ dashboard_url('contractApproval') }}" class="form form-action mt-3"
                            ...
                            <div id="myDiv">
                                ...
                                <p><span style="color:blue">
                                    ...
                                    <!--    <tr>-->
                                    <!--        <td>ا�ع� ��ا� </td>-->
                                    <!--        <td><input type="text" value="{{  $current_user->address  }}"></td>-->
                                    <!--    </tr>-->
                                    <!--    <tr>-->
                                    <!--        <td>ر��& ا��!���`ة</td>-->
                                    <!--        <td><input type="number" name="ID_number"-->
                                    <!--                value="{{ $Agreement->ID_number }}"></td>-->
                                    <!--    </tr>-->
                                    <!--    <tr>-->
                                    <!--        <td>ا�بر�`د ا�اْتر��� �`</td>-->
                                    <!--        <td><input type="text" readonly value="{{ $current_user->email }}"></td>-->
                                    <!--    </tr>-->
                                    ...
                                    <!--</table>-->
                                        ...
                                        <div class="col-md-12 mb-1">
                                            ...
                                            <input type="text" class="inputForm" style="width:50%"   name="address"readonly
