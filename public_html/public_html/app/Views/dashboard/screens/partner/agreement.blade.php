                             ...
                             <div id="myDiv">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" id="number">
                                        <span>{{ getNumberContract($Agreement->id) }}</span>
                                    </div>
                                </div>
                                ...
                                <p><span style="color:blue">
                                    ...
                                    <!--    <tr>-->
                                    <!--        <td>ا�ع� ��ا� </td>-->
                                    <!--        <td><input type="text" readonly name="address" value="{{  $current_user->address  }}"></td>-->
                                    <!--    </tr>-->
                                    <!--    <tr>-->
                                    <!--        <td>ر��& ا��!���`ة</td>-->
                                    ...
                                    <!--    <tr>-->
                                    <!--        <td>ا�بر�`د ا�اْتر��� �`</td>-->
                                    <!--        <td><input type="text" readonly  name="email" value="{{ $current_user->email }}"></td>-->
                                    <!--    </tr>-->
