...
<script>
function myFunction() {
  var copyText = document.getElementById("auth");
  copyText.select();
            ...
            <div class="row">
                            ...
                            <div class="text-left mt-3">
                                ...
                                <p class="text-muted mb-1 font-13">
                                   ...
                                   <div class="input-group mb-3">
                                      <input type="text" class="form-control"  aria-label="Recipient's username" aria-describedby="basic-addon2" value="https://labayh.sa/home-search-result?author={{$current_user->id}}" id="auth"  disabled>
                                      <div class="input-group-append">
                                        <button class="btn btn-outline-secondary" type="button" onclick="myFunction()"><i class="fas fa-clipboard"></i></button>
                                      </div>
                                  </div>
                                </p>
                            </div>
                ...
                <div class="col-12 col-lg-8 order-lg-4">
                        ...
                        <form action="{{ dashboard_url('update-your-profile') }}" class="form form-action mt-3"
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="email">{{__('Trade Name')}}</label>
                                        <input id="trade_name" type="text" class="form-control" name="trade_name"
                                               value="{{ $current_user->trade_name }}">
                                    </div>
                                </div>
                                <div class="w-100"></div>
                                ...
                                <div class="col-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="mobile" name="mobile"
                                               value="{{ $current_user->mobile }}" disabled>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                    ...
                    <div class="card relative p-3">
                        ...
                        <form action="{{ dashboard_url('update-your-payout-information') }}"
                              class="form form-action mt-3"
                              data-validation-id="form-payout"
                              method="post">
                            @include('common.loading')
                            <input type="hidden" name="user_id" value="{{ $user_id }}">
                            <input type="hidden" name="user_encrypt" value="{{ hh_encrypt($user_id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="payout_detail" id="payout-detail"
                                          class="form-control">{{$payout_detail}}</textarea>
                            </div>
                            <button type="submit" class="btn btn-success btn-rounded waves-effect waves-light right">
                                <span class="btn-label"><i class="mdi mdi-check-all"></i></span>
                                {{__('Update')}}
