    ...
    <div class="content-page">
        <div class="content">
            ...
            $earning = \App\Controllers\EarningController::get_inst()->getEarning(get_current_user_id());
             $Btax = (float)get_option('blagat_tax', 0);
              $Etax = (float)get_option('partner_commission_ex', 0);
            $Ctax = (float)get_option('partner_commission', 0);
            $htax = (float)get_option('home_tax', 0);
            $tt=PBooking(get_current_user_id());
            $tt1=PBooking(get_current_user_id(),'home')/1.05;
            
            $tt2=PBooking(get_current_user_id(),'experience')/1.05;
            ?>
                ...
                <div class="row">
                    <div class="col-md-6 col-xl-3">
                        <div class="card-box card-balance">
                            ...
                            <h2 class="my-3 text-center">
                                ...
                                <span data-plugin="counterup">{{ $tt/1.05 }}</span>
                            </h2>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card-box card-net-earning">
                            ...
                            <h2 class="my-3 text-center">
                                {{ current_currency('symbol') }}
                                <span data-plugin="counterup">{{ ($tt1-(($tt1*$Ctax)/100))+($tt2-(($tt2*$Etax)/100)) }}</span>
                            </h2>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card-box card-earning">
                            ...
                            <h4 class="mt-0 font-16">{{__('Remaining amount')}}</h4>
                            <h2 class="my-3 text-center">
                                {{ current_currency('symbol') }}
                                <span data-plugin="counterup">{{ ($tt1-(($tt1*$Ctax)/100))+($tt2-(($tt2*$Etax)/100))-PaymentsBlagat(get_current_user_id()) }}</span>
                            </h2>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card-box card-payout">
                            ...
                            <h2 class="my-3 text-center">
                                {{ current_currency('symbol') }}
                                <span data-plugin="counterup">{{PaymentsBlagat(get_current_user_id())}}</span>
                            </h2>
                        </div>
                    </div>
                </div>
