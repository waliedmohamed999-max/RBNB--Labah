            ...
            <h3 class="title">
                ...
                @if($offer!=null||$sm!=null)
                  <img  style="    height: 37px;float: left;"
                    src="{{asset('public/images/star-labayh.png')}}" >
