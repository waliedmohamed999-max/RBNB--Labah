...
@endif
<a href="https://api.whatsapp.com/send?phone=966581633837" class="float">
...
<div class="home-page ">
    ...
    <div class="hh-search-form-wrapper mm">
                    ...
                    <div class="col-md-6">
                        <div class="app-image">
                            <div class="main-image">
                                <!--<img data-src="{{asset('public/images/23548.png')}}" style="  width:228px" alt="�&ت��فر ع��0 ا�٬ app store �� ا�٬ andriod" loading="lazy" class="loaded" src="{{asset('public/images/23548.png')}}" data-was-processed="true">-->
                                ...
                                <!--<img src="{{asset('public/images/businesses-1.png')}}" alt="image"-->
                                <!--style="    width: 85%;">-->
                            ...
                            <!--    <img src="{{asset('public/images/main-mobile.png')}}" alt="image">-->
                            <!--</div>-->

                            <div class="circle-img">
                                <img src="{{asset('public/images/circle.png')}}" alt="image">
                            </div>
                                ...
                                <div class="thumbnail">
                                    <div class="thumbnail-outer">
                                        <div class="thumbnail-inner">
                                            ...
                                            <a href="https://labayh.sa/home/178/mkhym" target="_blank"
                                                class="btn postLabayh">{{ get_translate($page_title) }}</a>
...
<div class="gnservitems">
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-4 col-lg-4">
                <img data-src="img/360-degrees.png" loading="lazy" class="loaded"
                    src="{{asset('public/images/Co1mp.gif')}}" style="width: 50%;margin-top: 10%;"
            ...
            <div class="col-12 col-md-8 col-lg-8">
                <div class="row">
                    ...
                    <div class="col-6 col-md-2 col-lg-2 gnservitem">
                        <div class="iconn">
                            <img data-src="{{asset('public/images/boo.png')}}" alt="حجز �&ؤْد ���&ض�&��� " loading="lazy"
                                class="loaded" src="{{asset('public/images/boo.png')}}" data-was-processed="true">
                        </div>
                    ...
                    <div class="col-6 col-md-2 col-lg-2 gnservitem">
                        <div class="iconn">
                            <img data-src="img/paymentico.png" alt="طر� دفع آ�&� ة" loading="lazy" class="loaded"
                                src="{{asset('public/images/payicon.png')}}" data-was-processed="true">
                        </div>
                    ...
                    <div class="col-6 col-md-2 col-lg-2 gnservitem">
                        <div class="iconn">
                            <img data-src="img/customerservice-3@2x.png" alt="خد�&ة ع�&�اء" loading="lazy" class="loaded"
                                src="{{asset('public/images/supp.png')}}" data-was-processed="true">
                        </div>
                    ...
                    <div class="col-6 col-md-2 col-lg-2 gnservitem">
                        <div class="iconn">
                            <img data-src="img/037GoodReview.png" alt="ت��`�`�&ات �&��ث���ة" loading="lazy" class="loaded"
                                src="{{asset('public/images/mr.png')}}" data-was-processed="true">
                        </div>
                    ...
                    <div class="col-6 col-md-2 col-lg-2 gnservitem">
                        <div class="iconn">
                            <img data-src="img/search-2.png" alt="بحث �&ت�د�& ��ذْ�0" loading="lazy"
                                src="{{asset('public/images/se.png')}}" class="loaded" data-was-processed="true">
                        </div>
                    ...
                    <div class="col-6 col-md-2 col-lg-2 gnservitem">
                        <div class="iconn">
                            <img data-src="img/360-degrees.png" alt="ص��ر با� ��را�&�`ة" loading="lazy" class="loaded"
                                src="{{asset('public/images/poh.png')}}" data-was-processed="true">
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 " style="margin-top: 7%;">
                    <div class="app-download-content">
                        ...
                        <div class="btn-box">
                            <a href="https://labayh.sa/download"
                ...
                <div class="col-12 col-md-6 col-lg-6 downappmob" style=" padding-left: 5%;   text-align-last: center;">
                    <div class="app-image">
                        <div class="main-image">
                            ...
                            <img src="{{asset('public/images/mobile-app1.png')}}" alt="image">
                            <img src="{{asset('public/images/mobile-app2.png')}}" alt="image">
                        </div>

                        <div class="main-mobile-image">
                            <img style="width: 100%;" src="{{asset('public/images/main-mobile.png')}}" alt="image">
                        </div>
                ...
                <!--            <img data-src="{{asset('public/images/google-play.png')}}" style="max-width:25%" alt="ب�اجات Android" loading="lazy" class="loaded" src="{{asset('public/images/google-play.png')}}" data-was-processed="true"></a>-->

                <!--        <a href="https://labayh.sa/download" target="_blank" rel="noopener">-->
                <!--            <img data-src="{{asset('public/images/apple-store.png')}}" style="max-width:25%" alt="ب�اجات IOS" loading="lazy" class="loaded" src="{{asset('public/images/ios-store.png')}}" data-was-processed="true"></a>-->
                <!--    </p>-->
                <!--</div>-->
