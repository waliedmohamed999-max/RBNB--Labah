...
return [
    ...
    'booking_status' => [
        'pending' => [
         ...
         'Entry' => [
            'label' => awe_lang('Entry'),
            'icon' => 'fe-alert-triangle',
            'payment_text' => awe_lang('Entry confirmed')
        ],
    ...
    'partner_menu' => [
        ...
        [
         ...
         [
            'type' => 'item',
            'label' => awe_lang('Usage Agreement'),
            'icon' => '001_dashboard',
            'screen' => 'agreement',
        ],
        [
    ...
    'home_settings' => [
        ...
        'fields' => [
            ...
            [
             ...
             [
                'id' => 'use_offer',
                'label' => awe_lang('Is there a discount?'),
                'desc' => awe_lang('Is there a discount?'),
                'type' => 'on_off',
                'std' => 'off',
                'break' => true,
                'section' => 'pricing_options'
            ...
            [
                'id' => 'offer',
                'label' => awe_lang('discount percentage'),
                'desc' => awe_lang('discount percentage'),
                'type' => 'text',
                'layout' => 'col-12 col-md-6',
                'condition' => 'use_offer:is(on)',
                'section' => 'pricing_options'
            ],
            // [
    ...
    'experience_settings' => [
        ...
        'fields' => [
            ...
            [
                'id' => 'voteable',
                'label' => awe_lang('Voteable'),
                'type' => 'on_off',
                'condition' => 'experience_type:is(127)',
                'section' => 'detail_options'
            ],
            ...
            [
                ...
                'choices' => [
                    ...
                    'external_link' => awe_lang('External Link'),
                    'just_price' => awe_lang('Just Price, no date'),
                ],
                'std' => 'date_time',
                'style' => 'wide',
                'layout' => 'col-12 col-md-3',
             ...
             [
                'id' => 'subscribe_closed',
                'label' => awe_lang('Subscribe Closed'),
                'type' => 'on_off',
                'permission' => ['administrator'],
                'layout' => 'col-12 col-md-6',
                'section' => 'pricing_options'
            ...
            [
             ...
             [
                'id' => 'main_sponsors',
                'label' => awe_lang('main sponsors'),
                'type' => 'media_advanced',
                'desc' => awe_lang('Choose main sponsors'),
                'post_type' => 'experience',
                'style' => [400, 500],
                'section' => 'gallery_options'
            ],
            ...
            [
                'id' => 'co_sponsors',
                'label' => awe_lang('Co-Sponsors'),
                'type' => 'media_advanced',
                'desc' => awe_lang('Choose Co-Sponsors'),
                'post_type' => 'experience',
                'style' => [400, 500],
                'section' => 'gallery_options'
            ],
    ...
    'theme_options' => [
        ...
        'fields' => [
            ...
            [
                ...
                'label' => awe_lang('home_slider_title'),
                'type' => 'text',
                 'section' => 'page_options',
                'layout' => 'col-12 col-md-6',
                'translation' => true,
            ...
            [
                'id' => 'home_slider_desc',
                'label' => awe_lang('home_slider_desc'),
                'type' => 'text',
                 'section' => 'page_options',
                'layout' => 'col-12 col-md-6',
                'translation' => true,
              ...
              [
                'id' => 'home_slider_link',
                'label' => awe_lang('home_slider_link'),
                'type' => 'text',
                'section' => 'page_options',
                'layout' => 'col-12 col-md-6',
                'break' => true,
            ...
            [
             ...
             [
                'id' => 'call_to_video_blagat',
                'label' => awe_lang('Link will be formatted automatically after submitting form.'),
                'type' => 'text',
                'section' => 'page_options',
                'layout' => 'col-12 col-md-6',
                'break' => true,
            ...
            [
                ...
                'tab_content' => [
                    ...
                    [
                        'id' => 'blagat_tax',
                        'label' => awe_lang('Labayh Commission'),
                        'type' => 'text',
                        'std' => '10',
                        'layout' => 'col-12 col-md-6',
                        'section' => 'home_tab',
            ...
            [
             ...
             [
                'id' => 'partner_commission_ex',
                'label' => awe_lang('Percentage of experiences (%)'),
                'type' => 'text',
                'std' => 10,
                'layout' => 'col-12 col-md-6',
                'break' => true,
