...
Route::group(['prefix' => Config::get('awebooking.prefix_dashboard'), 'middleware' => ['authenticate', 'locale']], function () {
    ...
    Route::get('/favourite/{type}', 'DashboardController@_getFavAds')->name('getFavAds');
     Route::get('/favourite/remove/{type}/{id}', 'DashboardController@_removeFavAds')->name('removeFavAds');
      Route::get('/favourite/add/{type}/{id}', 'DashboardController@_addFavAds')->name('addFavAds');
    //Profile
    Route::get('profile', 'DashboardController@_getProfile')->name('profile');
    
     Route::get('agreement/{user_id?}', 'DashboardController@_getAgreement')->name('agreement');

     Route::post('contractApproval', 'DashboardController@_contractApproval')->name('contractApproval');

     Route::post('get-agreement-item', 'DashboardController@_getAgreementItem');
     Route::post('get-payment-item', 'DashboardController@_getPaymentItem');
     Route::post('update-agreement-item', 'DashboardController@_updateAgreement')->name('update-agreement-item');
    ...
    Route::get('Send-message', 'SendMessageController@index')->name('send-message');
    Route::get('Send-message-specific', 'SendMessageController@specificMessage')->name('send-message-specific');
    Route::post('Send-specific', 'SendMessageController@SendSpecific')->name('Send-specific');
    Route::post('Send-all', 'SendMessageController@SendMessage')->name('Send-all');
    //Coupon route
...
Route::group(['prefix' => Config::get('awebooking.prefix_dashboard'), 'middleware' => ['authenticate', 'locale', 'enable_experience']], function () {
    ...
    Route::get('center-vote/{page?}', 'Services\ExperienceController@_centerVote')->name('center-vote');
    ...
    Route::get('vote-ditails/{id}', 'Services\ExperienceController@_voteDitailsExperience')->name('vote-ditails');
     Route::post('vote-delete/{id}', 'Services\ExperienceController@_deleteVote')->name('vote-delete');
    
    Route::post('vote-ditails-add/{id}', 'Services\ExperienceController@_voteDitailsExperienceAdd')->name('vote-ditails-add');
    
    Route::get('vote-entrant/{id}', 'Services\ExperienceController@voteEntrant')->name('vote-entrant');
...
Route::group(['prefix' => Config::get('awebooking.prefix_dashboard'), 'middleware' => ['authenticate', 'locale', 'enable_home']], function () {
    ...
    Route::get('last-Minute-home/{page?}', 'Services\HomeController@_lastMinute')->name('last-Minute-home');

    Route::post('add-price-for-last-minute', 'Services\HomeController@_addPriceLastMinute')->name('add-price-for-last-minute');
    
     Route::post('change-last-status', 'Services\HomeController@_changeStatusLastMinute')->name('change-last-status');
