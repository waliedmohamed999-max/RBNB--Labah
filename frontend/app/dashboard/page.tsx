...
import { getDashboardSummary, getPublicSystemSettings, getSessionUser } from "@/lib/api";
...
export default async function DashboardPage() {
  ...
  const [currentUser, summary, publicSettings] = await Promise.all([
      ...
      <section className="overflow-hidden rounded-3xl border border-slate-100 bg-[#1a1f36] text-white shadow-[0_28px_90px_-48px_rgba(15,23,42,0.8)]">
        <div className="relative p-6 lg:p-8">
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="mt-5 text-3xl font-bold sm:text-4xl">أهلًا {displayName}</h1>
